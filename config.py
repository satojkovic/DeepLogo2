...
CROPPED_ANNOT_FILE = os.path.join(DATA_DIR, 'flickr_logos_27_dataset_training_set_annotation_cropped.txt')
CROPPED_ANNOT_FILE_TEST = os.path.join(DATA_DIR, 'flickr_logos_27_dataset_test_set_annotation_cropped.txt')
